...
public class MarketFragment extends Fragment implements Observer {
    TextView oilCount;
    TextView gasCount;
    ImageView sellOil;
    ImageView sellGas;
    ...
    public MarketFragment(MainActivity activity){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_market, parent, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        sellOil.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                activity.gameData.cash(activity.gameData.cash() + activity.gameData.barrels());
